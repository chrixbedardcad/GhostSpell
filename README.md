...
> **macOS note:** The uninstall script cannot revoke privacy permissions. After uninstalling, open **System Settings > Privacy & Security** and remove GhostType from both **Accessibility** and **Input Monitoring**.
