...
func PlayMicStart() { play(startWAV) }   // TODO: replace with mic_start.wav when available
func PlayMicStop()  { play(toggleWAV) }  // TODO: replace with mic_stop.wav when available
